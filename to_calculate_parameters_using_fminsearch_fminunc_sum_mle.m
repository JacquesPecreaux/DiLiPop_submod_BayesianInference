function [ input,fitting_results] = to_calculate_parameters_using_fminsearch_fminunc_sum_mle...
...
Options=optimset('TolFun',1e-8,'TolX',1e-12,'MaxFunEvals',5000, 'MaxIter' , 5000);
...
if ~isempty(find(ismember(models,'MonoExpo'),1))
    ...
    [x_prefit, ~, exitflag]=fminsearch(@(par) Loglikelihood2_total(par, input,'MonoExpo', @simple_exp2_beta_norm, nbEmbryo_givenCondition, size_population2), ...
        [1], Options);
...
if ~isempty(find(ismember(models,'DoubleExpo'),1))
    ...
    [x2_prefit, ~, exitflag]=fminsearch(@(par) Loglikelihood2_total(par, input,'DoubleExpo', @double_exp2_beta_norm, nbEmbryo_givenCondition, size_population2), ...
        [0.5 0.5 2], Options);
...
if ~isempty(find(ismember(models,'DoubleExpo_fixedT0'),1)) && exist('fixed_short_lifetime','var') == 1 && ~isempty(fixed_short_lifetime)
     ...
     [x2_prefit_, ~, exitflag]=fminsearch(@(par) Loglikelihood2_total(par, input,'DoubleExpo_fixedT0', @double_exp2_beta_norm_fixedT0, ...
         nbEmbryo_givenCondition, size_population2,fixed_short_lifetime), [0.5 2], Options);
...
if ~isempty(find(ismember(models,'DoubleExpo_fixedT0P0'),1)) && exist('fixed_short_lifetime','var') == 1 && ~isempty(fixed_short_lifetime) ...
     ...
     [x2_prefit__, ~, exitflag]=fminsearch(@(par) Loglikelihood2_total(par, input,'DoubleExpo_fixedT0P0', @double_exp2_beta_norm_fixedT0P0, ...
         nbEmbryo_givenCondition, size_population2,fixed_short_lifetime,fixed_short_percent), [0.5], Options);
...
if ~isempty(find(ismember(models,'MonoExpo_stretched'),1))
    ...
    [xS_prefit, ~, exitflag]=fminsearch(@(par) Loglikelihood2_total(par, input,'MonoExpo_stretched', @simple_exp2_stretched_beta_norm, nbEmbryo_givenCondition,size_population2), ...
        [1 1],Options);
...
if ~isempty(find(ismember(models,'TripleExpo'),1))
    ...
    [x3_prefit, ~, exitflag]=fminsearch(@(par) Loglikelihood2_total(par, input,'TripleExpo', @triple_exp2_beta_norm, nbEmbryo_givenCondition,size_population2),...
...
if ~isempty(find(ismember(models,'TripleExpo_fixedT0'),1)) && exist('fixed_short_lifetime','var') == 1
    ...
    [x3_prefit_, ~, exitflag]=fminsearch(@(par) Loglikelihood2_total(par, input,'TripleExpo_fixedT0', @triple_exp2_beta_norm_fixedT0, nbEmbryo_givenCondition, size_population2, fixed_short_lifetime), ...
