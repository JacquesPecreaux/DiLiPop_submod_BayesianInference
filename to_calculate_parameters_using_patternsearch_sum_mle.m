function [ input,fitting_results] = to_calculate_parameters_using_patternsearch_sum_mle...
...
Options=optimset('TolFun',1e-15,'TolX',1e-15,'MaxIter',100000,'MaxFunEvals',1000000); %,'TolMesh',1e-6);
...
if ~isempty(find(ismember(models,'MonoExpo'),1))
    ...
    [x, ~, exitflag]=patternsearch(@(par) Loglikelihood2_total(par, input,'MonoExpo', @simple_exp2_beta_norm, nbEmbryo_givenCondition, size_population2), ...
        [1], [], [], [], [],[0.1], [10],[],Options);
...
if ~isempty(find(ismember(models,'DoubleExpo'),1))
    ...
    [x2, ~, exitflag]=patternsearch(@(par) Loglikelihood2_total(par, input,'DoubleExpo', @double_exp2_beta_norm, nbEmbryo_givenCondition, size_population2), ...
        [0.5 2 0.5], [], [], [], [],[0 1 0.2], [1 10  1], [], Options);
...
if ~isempty(find(ismember(models,'DoubleExpo_fixedT0'),1)) && exist('fixed_short_lifetime','var') == 1 && ~isempty(fixed_short_lifetime)
    ...
    [x2_, ~, exitflag]=patternsearch(@(par) Loglikelihood2_total(par, input,'DoubleExpo_fixedT0', @double_exp2_beta_norm_fixedT0, nbEmbryo_givenCondition, size_population2,fixed_short_lifetime), ...
...
if ~isempty(find(ismember(models,'DoubleExpo_fixedT0P0'),1)) && exist('fixed_short_lifetime','var') == 1 && ~isempty(fixed_short_lifetime) ...
    ...
    [x2__, ~, exitflag]=patternsearch(@(par) Loglikelihood2_total(par, input,'DoubleExpo_fixedT0P0', ...
        @double_exp2_beta_norm_fixedT0P0, nbEmbryo_givenCondition, size_population2,fixed_short_lifetime,fixed_short_percent), ...
        [0.5], [], [], [], [],[0.2], [1/(fixed_short_lifetime+0.1)], [], Options);
...
if ~isempty(find(ismember(models,'MonoExpo_stretched'),1))
    ...
    [xS, ~, exitflag]=patternsearch(@(par) Loglikelihood2_total(par, input,'MonoExpo_stretched', @simple_exp2_stretched_beta_norm, nbEmbryo_givenCondition,size_population2), ...
...
if ~isempty(find(ismember(models,'TripleExpo'),1))
    ...
    [x3, ~, exitflag]=patternsearch(@(par) Loglikelihood2_total(par, input,'TripleExpo', @triple_exp2_beta_norm, nbEmbryo_givenCondition,size_population2),...
        [0.4 5 0.4 1.4 0.5 ], [], [], [], [],[0 2.1 0 0.67 0.2], [1 8.3 1 3.3 0.67], [],Options);
...
if ~isempty(find(ismember(models,'TripleExpo_fixedT0'),1)) && exist('fixed_short_lifetime','var') == 1 && ~isempty(fixed_short_lifetime)
    ...
    [x3_, ~, exitflag]=patternsearch(@(par) Loglikelihood2_total(par, input,'TripleExpo_fixedT0', @triple_exp2_beta_norm_fixedT0, nbEmbryo_givenCondition, size_population2, fixed_short_lifetime), ...
         [0.4 0.4 1.5 0.5], [], [], [], [],[0 0 0.67 0.2], [1 1 3.3 0.67], [], Options);
...
if ~isempty(find(ismember(models,'TripleExpo_fixedT0P0'),1)) && exist('fixed_short_lifetime','var') == 1  && ~isempty(fixed_short_lifetime)...
   ...
   [x3__, ~, exitflag]=patternsearch(@(par) Loglikelihood2_total(par, input,'TripleExpo_fixedT0P0', @triple_exp2_beta_norm_fixedT0P0, nbEmbryo_givenCondition, ...
       size_population2, fixed_short_lifetime,fixed_short_percent ), [0.4 1.5 0.5], [], [], [], [],[0 0.67 0.2], [1 3.3 0.67], [], Options);
