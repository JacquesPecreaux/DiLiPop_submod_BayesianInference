function [ input,fitting_results] = to_calculate_parameters_using_fminsearch_sum_mle...
...
if ~isempty(find(ismember(models,'DoubleExpo_fixedT0'),1)) && exist('fixed_short_lifetime','var') == 1 && ~isempty(fixed_short_lifetime)
    ...
    [x2_, ~, exitflag]=fminsearch(@(par) Loglikelihood2_total(par, input,'DoubleExpo_fixedT0', @double_exp2_beta_norm_fixedT0, ...
